  ...
  return (
    <Card className="w-full max-w-md mx-auto border-roomify-purple-light">
      <CardHeader className="space-y-1">
        <CardTitle className="text-2xl text-center text-roomify-purple">Create an Account</CardTitle>
      ...
      <CardContent className="space-y-4">
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex items-center space-x-2">
            ...
            >
              I agree to the{' '}
              <Link to="/terms" className="text-roomify-blue hover:text-roomify-blue-dark underline">
                Terms of Service
              </Link>
              {' '}and{' '}
              <Link to="/privacy" className="text-roomify-blue hover:text-roomify-blue-dark underline">
                Privacy Policy
              </Link>
            </label>
          </div>
